...
module.exports = class StepfunctionStack extends Stack {
  constructor(scope, id, props) {
    ...
    const autoScalingGroupName = "attlassian-test";
    ...
    updateScalingGroupTask.addCatch(sendFailureNotification);
    ...
    const stepChain = wait
      .next(updateScalingGroupTask);
